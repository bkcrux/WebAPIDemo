...
namespace ExpenseTracker
{
    public class ExpenseTrackerConstants
    {
        ...
        public const string ExpenseTrackerAPI = "http://bkcodestudyexpensetracker.azurewebsites.net/";
        ...
        public const string IdSrvIssuedUri = "https://expensetrackeridsrv3/embedded";
        public const string IdSrv = "https://bkcodestudyidsrv.azurewebsites.net/identity";
